...
class GetGroupTestA extends AbstractProcess
{
    ...
    protected function run($arg)
    {
        ...
        go(function () {
            ...
            var_dump("GetGroupTestA 进程开启,正在监听中.....");
            $token = "2021071555:AAFtCZc2zvWqw96lPeXgM9n0TdjWGemyGZU";  # 机器人A 的api token
            $group_id = "-628096883";  #你管理 群的 id   A
