var changeRefreshStr = localStorage.getItem("changeRefresh");
// console.log("是否开启点击刷新"+changeRefreshStr);
        ...
        if (_this.attr("target")) {
            ...
            if ((!that.hasTab(menuGuid)) && _this.siblings("dl.layui-nav-child").length == 0) {
                ...
                element.tabAdd(tabFilter, {
                    title: title,
                    content: "<iframe id='laftMenu" + menuGuid + "' frameborder='0' src='" + _this.attr("data-url") + "' data-id='" + tabIdIndex + "' style='padding: 0px; margin: 0px; border-width: 0px;' ></iframe>",
                    id: menuGuid
                })
                //当前窗口内容
                var curmenu = {
                ...
                //2021年6月2日14:13:18修改 这行代码没有效果,暂时去掉
