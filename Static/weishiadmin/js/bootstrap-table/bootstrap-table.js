	...
	var EN = {
	  ...
	  formatShowingRows: function formatShowingRows(pageFrom, pageTo, totalRows, totalNotFiltered) {
	    if (totalNotFiltered !== undefined && totalNotFiltered > 0 && totalNotFiltered > totalRows) {
	      return "显示第 ".concat(pageFrom, " 到第 ").concat(pageTo, " 记录，总共 ").concat(totalRows, " 记录 (filtered from ").concat(totalNotFiltered, " total rows)");
	    }

	    return "显示第 ".concat(pageFrom, " 到 ").concat(pageTo, " 记录，总共 ").concat(totalRows, " 记录");
	  },
